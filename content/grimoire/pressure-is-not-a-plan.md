---
title: "Pressure Is Not a Plan"
metaTitle: "Pressure Is Not a Plan"
...
faq:
  - q: "How many companies actually have an AI strategy?"
    a: >
      About 15%. Supermetrics surveyed 435 marketing leaders across five countries for its
      July 2026 AI Readiness Gap report and found only 15% had a clear strategy with defined
      owners and success metrics. The other 85% either had no formal strategy, partial clarity
      on use cases, or a mention of AI in planning with nothing prioritized.
  - q: "Does using ChatGPT for content count as AI adoption?"
    a: >
      No. That is usage, not adoption. In the same survey 52% of SMB teams used AI for content
      creation, but only 6% described AI as fully embedded in their workflows. One person with a
      chatbot is a habit. A company with an owner, a defined job, and a number attached is a system.
  - q: "Is it smarter to wait on AI until the tools settle down?"
    a: >
      Only if waiting is a decision with an owner and a trigger. A plan is not a bet on a specific
      tool, it is a decision about the job you want done. Tools change every quarter. The job does
      not. Name the outcome, name the owner, swap the tools underneath.
  - q: "Who should own AI on a marketing team?"
    a: >
      One named person, and it can be a person who already has a job. Ownership means someone is
      accountable for what AI is for here and what happens when it does not work. What nobody owns,
      nobody improves. Ownership is the thing 85% of surveyed teams are missing, not budget.
  - q: "What does a minimum AI plan actually look like?"
    a: >
      One owner, one sentence about what AI is for in your business, and one number that tells you
      if it worked. That is an afternoon, not a budget line or a consulting engagement. The
      companies with no plan skipped the afternoon, not the money.
---
...
This reads as a paperwork problem and it is not. MIT's NANDA group ran 150 leadership interviews, surveyed 350 employees, and analyzed 300 public AI deployments for [The GenAI Divide](https://finance.yahoo.com/news/mit-report-95-generative-ai-105412686.html), and found 95% of enterprise generative AI pilots produced no measurable return. The models worked fine. What broke was ownership, the definition of success, and workflows nobody redesigned before bolting a tool onto them.
...
This is the sequence problem wearing new clothes. A pen topples a skyscraper in twenty nine steps because the [order is doing the work, not the volume](/grimoire/the-domino-effect). AI with no plan is tactics with no sequence. Same failure, faster clock. The [Eight Dominoes](/eight-dominoes) run the same way: the first decision sets what every decision after it is allowed to be, and running the later ones harder never repairs a missing first one.

A plan alone does not finish the job either. The machine still cannot supply the idea sitting at the center of it, which is [why you have to be the originator](/grimoire/the-center-point) and not the operator. Decide the job, then bring the idea. Skip either one and the tool fills the gap with the average.
