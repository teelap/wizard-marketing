...
date: 2026-09-03
category: Sales
description: "Every objection is a symptom. The belief underneath it is the disease. Handling the objection legitimizes the belief instead of breaking it."
excerpt: "When a buyer says your price is too high, they are almost never talking about price, and answering the price is how you lose the deal politely."
lead: "Every objection you hear is a symptom. The limiting belief underneath it is the disease, and handling the objection out loud legitimizes the belief instead of breaking it."
faq:
  - q: "What does it mean that the objection is never the objection?"
    a: >
      It means the reason a buyer gives you is rarely the reason they are
      saying no. "Too expensive" usually means "I do not believe this will
      work," and any price is too high for something that will not work.
      The stated objection is the symptom. The belief underneath is the
      disease. This is Domino 06, Barrier Breakdown, in Jake Tlapek's Eight
      Dominoes framework.
  - q: "Why do customers say a product is too expensive?"
    a: >
      Usually because they doubt the outcome, not the number. Test it by
      dropping the price and watching who still walks. The ones who leave
      anyway were never blocked by price. They were blocked by a belief the
      discount never touched, which is why discounting closes fewer deals
      than sellers expect.
  - q: "Should I offer a discount to overcome a price objection?"
    a: >
      No, because a concession confirms the doubt. When you shorten the
      contract or cut the price to make leaving easy, the buyer hears you
      agreeing that the thing might not work. You did not remove the doubt.
      You signed it. Reframe the belief instead and the price stops being
      the conversation.
  - q: "How do I find the real reason customers do not buy?"
    a: >
      Ask the near-misses, not the customers. Talk to five people who almost
      bought and did not, and ask what nearly stopped them. Then, for each
      objection you hear often, write the belief that would have to be true
      about your product, your category, or the buyer themselves for that no
      to make sense. That list is your real sales problem.
  - q: "When should I address an objection in my marketing?"
    a: >
      Before the buyer ever says it. By the time an objection is spoken the
      belief has hardened and you are arguing with concrete. Research from
      Matthew Dixon and Ted McKenna's study of 2.5 million recorded sales
...
On August 7, 2025, Warby Parker announced it was [sunsetting Home Try-On by year end](https://www.retaildive.com/news/warby-parker-ends-home-try-on-program-focuses-stores-digital-q2/757070/). Co-founder Neil Blumenthal's stated reason: most home try-on users now live within thirty minutes of one of the company's roughly 300 stores.
...
This is where it sits in sequence. [The promise earns the first sixty seconds](/grimoire/the-sixty-second-promise). Barrier Breakdown is Domino 06 in the [Eight Dominoes](/eight-dominoes), the first defensive move in the chain, and it exists to protect the message the earlier dominoes already built. Skip it and everything standing in front of it topples into a wall.
