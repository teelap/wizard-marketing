...
2. **Build the deck** — the well of distinct subjects to deal from:
   ...
   - The **eight messaging concepts stay in the deck as ordinary subjects** — no privileged weekly hero; they take their turn like any other subject so the week doesn't become eight book ads. But **the book branding is now ON** (published 2026-08-03; pause lifted 2026-08-06): when one of the eight comes up, you may name it, credit the book, and close on "Buy the book." Still teach the concept before you reach for the label — the audience meets the idea first, the brand name second.
